...
Standalone Question:"""
                    ...
                    for i, doc in enumerate(source_docs):
                        ...
                        # استخراج نام فایل و حذف مسیرهای اضافی
...
2. You MUST cite your sources using EXACTLY the document name and page numbers provided in the context below (e.g., [Manual.pdf, Page 8]). DO NOT invent, guess, or hallucinate page numbers.
                    ...
                    if len(source_docs) > 0:
                        with st.expander("📑 Extracted Document Chunks"):
                            for i, doc in enumerate(source_docs):
                                ...
                                sources_for_db.append({"page": page, "source": source_name, "content": content})
                                st.write(f"**Source: {source_name} (Page {page + 1}):**")
                                st.write(content)
